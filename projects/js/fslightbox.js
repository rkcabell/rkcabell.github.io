          ...
          var e = document.getElementsByTagName('a'),
            t = function (t) {
              ...
              if (i instanceof Element) {
                applyWatermark(i) // Assuming 'i' is the container element for the content
              }
        ...
        for (
          var e = document.getElementsByTagName('a'),
            t = function (t) {
              ...
              var i =
                '#' === n.charAt(0)
                  ? document.getElementById(n.substring(1)).cloneNode(true)
                  : n
              if (i.removeAttribute) i.removeAttribute('id') // Check if it's a DOM element and remove id

              fsLightboxInstances[o].props.sources.push(i)
              fsLightboxInstances[o].elements.a.push(e[t])
              var r = fsLightboxInstances[o].props.sources.length - 1

              // Apply watermark here if the source is a DOM element that can contain children
              if (i instanceof Element) {
                applyWatermark(i) // Assuming 'i' is the container element for the content
              }
